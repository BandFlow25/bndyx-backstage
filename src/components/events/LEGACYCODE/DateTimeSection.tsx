...
//           className="relative" 
//           onClick={(e) => {
//             console.log('%c [DATE SECTION] Start date container onClick', 'background: #22c55e; color: white;', {
//               target: e.target,
...
//           }}
//           onMouseDown={(e) => {
//             console.log('%c [DATE SECTION] Start date container onMouseDown', 'background: #22c55e; color: white;');
//             e.stopPropagation();
//           }}
//           onPointerDown={(e) => {
//             console.log('%c [DATE SECTION] Start date container onPointerDown', 'background: #22c55e; color: white;');
//             e.stopPropagation();
//           }}
//           onMouseUp={(e) => {
//             console.log('%c [DATE SECTION] Start date container onMouseUp', 'background: #22c55e; color: white;');
//             e.stopPropagation();
//           }}
//           onTouchStart={(e) => {
//             console.log('%c [DATE SECTION] Start date container onTouchStart', 'background: #22c55e; color: white;');
//             e.stopPropagation();
//           }}
//           onTouchEnd={(e) => {
//             console.log('%c [DATE SECTION] Start date container onTouchEnd', 'background: #22c55e; color: white;');
//             e.stopPropagation();
//           }}
//           onTouchMove={(e) => {
//             console.log('%c [DATE SECTION] Start date container onTouchMove', 'background: #22c55e; color: white;');
//             e.stopPropagation();
//           }}
//         >
//           <BndyDatePicker
...
//               console.log('%c START DATE SELECTED', 'background: #00ff00; color: black; font-size: 16px');
//               console.log('Date:', date);
//               console.log('Event:', new Event('click'));
...
//             }}
//             onOpen={() => {
//               console.log('%c START DATE PICKER OPENED', 'background: #0088ff; color: white; font-size: 16px');
//               if (onDatePickerOpen) onDatePickerOpen();
//             }}
//             onClose={() => {
//               console.log('%c START DATE PICKER CLOSED', 'background: #ff8800; color: black; font-size: 16px');
//               if (onDatePickerClose) onDatePickerClose();
//             }}
...
//                 onSelect={(date: Date | undefined) => {
//                   console.log('%c END DATE SELECTED', 'background: #ff00ff; color: white; font-size: 16px');
//                   console.log('Date:', date);
//                   console.log('Event:', new Event('click'));
//                   console.log('Stack trace:', new Error().stack);
...
//                 }}
//                 onOpen={() => {
//                   console.log('%c END DATE PICKER OPENED', 'background: #0088ff; color: white; font-size: 16px');
//                   if (onDatePickerOpen) onDatePickerOpen();
//                 }}
//                 onClose={() => {
//                   console.log('%c END DATE PICKER CLOSED', 'background: #ff8800; color: black; font-size: 16px');
//                   if (onDatePickerClose) onDatePickerClose();
//                 }}
