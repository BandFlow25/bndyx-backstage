...
//       {/* Event Type */}
//       <div className="mb-4">
//         <label htmlFor="eventType" className="block mb-1 font-medium text-slate-700 dark:text-slate-100">
//           Event Type*
//         </label>
...
//             <>
//               {/* 'Available' option removed as requested but code preserved for future use */}
...
//             <svg className="h-5 w-5 text-slate-500 dark:text-slate-100" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
...
//           />
//           <label htmlFor="isPublic" className="ml-2 text-sm font-medium text-slate-700 dark:text-slate-100">
