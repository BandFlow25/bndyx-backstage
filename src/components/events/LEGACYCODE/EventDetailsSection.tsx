...
//       {/* Title */}
//       <div className="mb-4">
//         <label htmlFor="title" className="block mb-1 font-medium text-slate-700 dark:text-slate-100">
//           Event Title*
//         </label>
//         <input
//           type="text"
...
//       {/* Description */}
//       <div className="mb-4">
//         <label htmlFor="description" className="block mb-1 font-medium text-slate-700 dark:text-slate-100">
//           Description
//         </label>
//         <textarea
//           id="description"
